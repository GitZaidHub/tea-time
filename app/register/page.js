...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
   ...
   toast.error("this function not available")
  };
  ...
  return (
    <>
      ...
      <h1 className="flex items-center justify-center text-red-500"> Use google or github to login , email service is not availaible</h1>
        <div className="bg-[#e7e3e0] rounded-2xl flex flex-row-reverse max-w-3xl p-5 box-border shadow-xl">
          <div className="md:w-1/2 px-8">
            <h2 className="font-bold text-3xl text-[#002D74]">Register</h2>
            <p className="text-sm mt-4 text-[#002D74]">
              If you already a member, <Link className="text-blue-950 font-semibold" href={"/login"}>Login</Link>
            </p>

  ...
  return (
    ...
    <div className="bg-[#e7e3e0] rounded-2xl flex max-w-3xl p-5 box-border shadow-xl">
        ...
        <div className="md:w-1/2 px-8">
            ...
            <form action="" className="flex flex-col gap-4">
                <input className="p-2 mt-8 rounded-xl border border-gray-300 focus:outline-none focus:ring focus:ring-[#002D74]" type="email" name="email" placeholder="Email"/>
                <div className="relative">
                    <input className="p-2 rounded-xl border border-gray-300 w-full focus:outline-none focus:ring focus:ring-[#002D74]" type="password" name="password" id="password" placeholder="Password"/>
            ...
            <button onClick={()=>signIn("google")} className="bg-white border border-gray-300 py-2 w-full rounded-xl mt-5 flex justify-center items-center text-sm hover:scale-105 duration-300 hover:bg-[#60a8bc4f] font-medium">
            ...
            <button onClick={()=>signIn("github")} className="bg-white border border-gray-300 py-2 w-full rounded-xl mt-5 flex justify-center items-center text-sm hover:scale-105 duration-300 hover:bg-[#60a8bc4f] font-medium">
    ...
    Login with GitHub
        ...
        <div className=" flex items-center justify-center w-1/2">
            <img className="rounded-2xl max-h-[600px] flex items-center justify-center object-cover" src="https://cdn.pixabay.com/animation/2024/09/09/14/14/14-14-48-336_512.gif" alt="Login GIF" />
        </div>
    </div>
</section>
